...
export function buildCove(B, arena = false) {
  ...
  // Prop: Cargo Crate
  box(-7, 4.5, -7, 1.8, 1.8, 1.8, { ink: BL });
  box(-7, 4.5, -7, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(-15, 0, -39, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(-3, 0, -15, 1.8, 1.8, 1.8, { ink: BL });
  box(-3, 0, -15, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Mooring Bollard
  cyl(45, 0, -27, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(45, 0 + 1.0, -27, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(37, 0, -15, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(29, 0, -7, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(29, 0 + 1.0, -7, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(37, 0, -3, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(41, 0, -39, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(41, 0 + 1.0, -39, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(5, 0, -19, 1.8, 1.8, 1.8, { ink: BL });
  box(5, 0, -19, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(-39, 0, 49, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(9, 0, 21, 1.8, 1.8, 1.8, { ink: BL });
  box(9, 0, 21, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Mooring Bollard
  cyl(45, 0, 1, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(45, 0 + 1.0, 1, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Cargo Crate
  box(13, 0, 25, 1.8, 1.8, 1.8, { ink: BL });
  box(13, 0, 25, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(13, 0, 45, 1.8, 1.8, 1.8, { ink: BL });
  box(13, 0, 45, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
