...
export function buildHarborPort(B, arena = false) {
  ...
  // Prop: Cargo Crate
  box(-39, 0, -23, 1.8, 1.8, 1.8, { ink: BL });
  box(-39, 0, -23, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(-31, 0, -11, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(17, 0, -7, 1.8, 1.8, 1.8, { ink: BL });
  box(17, 0, -7, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Cargo Crate
  box(13, 0, 17, 1.8, 1.8, 1.8, { ink: BL });
  box(13, 0, 17, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Mooring Bollard
  cyl(17, 0, 41, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(17, 0 + 1.0, 41, 0.5, 0.2, { seg: 8, ink: BK });
