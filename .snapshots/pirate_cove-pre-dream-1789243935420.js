...
export function buildPirateCove(B, arena = false) {
  ...
  stairs(0, 0, -12, '-z', stepCount, 3.2, { rise: rs, run: rn });
  stairs(0, 0, 12, '+z', stepCount, 3.2, { rise: rs, run: rn });
  ...
  // === MACRO STRUCTURE: Galleon Sterncastle at (-31, 0, -37) ===
  box(-31, 0, -37, 8.0, 2.0, 6.0, { ink: BL });
  box(-31, 0 + 2.0, -37, 7.5, 2.5, 5.5, { ink: OR });
  slab(-31 - 4.0, -37 - 3.2, -31 + 4.0, -37 + 3.2, 0 + 4.5, 0.3, { ink: OR });
  rail(-31 - 4.0, -37 - 3.2, -31 + 4.0, -37 - 3.2, 0 + 4.5, { ink: BK });
  rail(-31 - 4.0, -37 + 3.2, -31 + 4.0, -37 + 3.2, 0 + 4.5, { ink: BK });
  rail(-31 - 4.0, -37 - 3.2, -31 - 4.0, -37 + 3.2, 0 + 4.5, { ink: BK });
  box(-31, 0 + 4.8, -37, 1.0, 3.0, 0.5, { ink: BK });
  ring(-31, 0 + 9.3, -37, 'z');
  pickup(-31, 0 + 4.7, -37);

  // === MACRO STRUCTURE: Lighthouse Beacon at (-31, 0, -19) ===
  cyl(-31, 0, -19, 2.2, 5.5, { seg: 10, ink: BL });
  slab(-31 - 2.8, -19 - 2.8, -31 + 2.8, -19 + 2.8, 0 + 5.0, 0.3, { ink: OR });
  rail(-31 - 2.8, -19 - 2.8, -31 + 2.8, -19 - 2.8, 0 + 5.0, { ink: BK });
  rail(-31 - 2.8, -19 + 2.8, -31 + 2.8, -19 + 2.8, 0 + 5.0, { ink: BK });
  cyl(-31, 0 + 5.3, -19, 1.5, 1.5, { seg: 8, noCollide: true, ink: OR });
  ring(-31, 0 + 9.3, -19, 'z');
  pickup(-31, 0 + 5.2, -19);

  // === MACRO STRUCTURE: Cargo Crane Gantry at (-31, 0, 5) ===
  box(-31 - 2.5, 0, 5 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-31 + 2.5, 0, 5 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-31 - 2.5, 0, 5 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-31 + 2.5, 0, 5 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  slab(-31 - 3.0, 5 - 3.0, -31 + 3.0, 5 + 3.0, 0 + 5.5, 0.4, { ink: OR });
  box(-31, 0 + 5.9, 5 - 1.5, 2.5, 1.8, 2.5, { ink: BL });
  box(-31, 0 + 5.9, 5 + 2.5, 0.6, 0.6, 3.0, { ink: BK });
  ring(-31, 0 + 8.3, 5 + 4.0, 'z');
  pickup(-31, 0 + 6.1, 5 - 1.5);
  ...
  cyl(-35, 0, -27, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-35, 0 + 1.0, -27, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Mooring Bollard
  cyl(-15, 0, -7, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-15, 0 + 1.0, -7, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(-39, 0, -15, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Timber Stack
  box(5, 0, -31, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(13, 0, -15, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(1, 0, -19, 1.8, 1.8, 1.8, { ink: BL });
  box(1, 0, -19, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(9, 0, -39, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(33, 0, -23, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(33, 0 + 1.0, -23, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Timber Stack
  box(-31, 0, 25, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(-31, 0, 37, 1.8, 1.8, 1.8, { ink: BL });
  box(-31, 0, 37, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(-39, 0, 9, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(-27, 0, 37, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-27, 0 + 1.0, 37, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(5, 0, 21, 1.8, 1.8, 1.8, { ink: BL });
  box(5, 0, 21, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
