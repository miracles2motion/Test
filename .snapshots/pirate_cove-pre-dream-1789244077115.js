...
export function buildPirateCove(B, arena = false) {
  ...
  // Prop: Timber Stack
  box(-19, 0, -43, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Timber Stack
  box(-23, 0, -27, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(9, 4.5, -7, 1.8, 1.8, 1.8, { ink: BL });
  box(9, 4.5, -7, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(-19, 0, 25, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(-11, 4.5, 9, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-11, 4.5 + 1.0, 9, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(25, 0, 17, 1.8, 1.8, 1.8, { ink: BL });
  box(25, 0, 17, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(33, 0, 17, 1.8, 1.8, 1.8, { ink: BL });
  box(33, 0, 17, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(29, 0, 13, 3.0, 1.0, 1.2, { ink: OR });
