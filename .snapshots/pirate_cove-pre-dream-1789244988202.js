...
export function buildPirateCove(B, arena = false) {
  ...
  // === MACRO STRUCTURE: Cargo Crane Gantry at (-37, 0, -43) ===
  box(-37 - 2.5, 0, -43 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-37 + 2.5, 0, -43 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-37 - 2.5, 0, -43 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-37 + 2.5, 0, -43 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  slab(-37 - 3.0, -43 - 3.0, -37 + 3.0, -43 + 3.0, 0 + 5.5, 0.4, { ink: OR });
  box(-37, 0 + 5.9, -43 - 1.5, 2.5, 1.8, 2.5, { ink: BL });
  box(-37, 0 + 5.9, -43 + 2.5, 0.6, 0.6, 3.0, { ink: BK });
  ring(-37, 0 + 8.3, -43 + 4.0, 'z');
  pickup(-37, 0 + 6.1, -43 - 1.5);

  // === MACRO STRUCTURE: Cargo Crane Gantry at (-37, 0, -13) ===
  box(-37 - 2.5, 0, -13 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-37 + 2.5, 0, -13 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-37 - 2.5, 0, -13 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-37 + 2.5, 0, -13 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  slab(-37 - 3.0, -13 - 3.0, -37 + 3.0, -13 + 3.0, 0 + 5.5, 0.4, { ink: OR });
  box(-37, 0 + 5.9, -13 - 1.5, 2.5, 1.8, 2.5, { ink: BL });
  box(-37, 0 + 5.9, -13 + 2.5, 0.6, 0.6, 3.0, { ink: BK });
  ring(-37, 0 + 8.3, -13 + 4.0, 'z');
  pickup(-37, 0 + 6.1, -13 - 1.5);

  // === MACRO STRUCTURE: Galleon Sterncastle at (-25, 0, 29) ===
  box(-25, 0, 29, 8.0, 2.0, 6.0, { ink: BL });
  box(-25, 0 + 2.0, 29, 7.5, 2.5, 5.5, { ink: OR });
  slab(-25 - 4.0, 29 - 3.2, -25 + 4.0, 29 + 3.2, 0 + 4.5, 0.3, { ink: OR });
  rail(-25 - 4.0, 29 - 3.2, -25 + 4.0, 29 - 3.2, 0 + 4.5, { ink: BK });
  rail(-25 - 4.0, 29 + 3.2, -25 + 4.0, 29 + 3.2, 0 + 4.5, { ink: BK });
  rail(-25 - 4.0, 29 - 3.2, -25 - 4.0, 29 + 3.2, 0 + 4.5, { ink: BK });
  box(-25, 0 + 4.8, 29, 1.0, 3.0, 0.5, { ink: BK });
  ring(-25, 0 + 9.3, 29, 'z');
  pickup(-25, 0 + 4.7, 29);
  ...
  // Prop: Cargo Crate
  box(-47, 0, -19, 1.8, 1.8, 1.8, { ink: BL });
  box(-47, 0, -19, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(-7, 0, -39, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(-47, 0, -43, 1.8, 1.8, 1.8, { ink: BL });
  box(-47, 0, -43, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(-15, 0, -15, 1.8, 1.8, 1.8, { ink: BL });
  box(-15, 0, -15, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Cargo Crate
  box(-7, 4.5, -11, 1.8, 1.8, 1.8, { ink: BL });
  box(-7, 4.5, -11, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Mooring Bollard
  cyl(-43, 0, -27, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-43, 0 + 1.0, -27, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Timber Stack
  box(-35, 0, -27, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(-31, 0, -27, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-31, 0 + 1.0, -27, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(1, 0, -43, 1.8, 1.8, 1.8, { ink: BL });
  box(1, 0, -43, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Mooring Bollard
  cyl(17, 0, -7, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(17, 0 + 1.0, -7, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(5, 0, -47, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(21, 0, -23, 1.8, 1.8, 1.8, { ink: BL });
  box(21, 0, -23, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(13, 0, -43, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(25, 0, -23, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(25, 0 + 1.0, -23, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Timber Stack
  box(25, 0, -31, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(5, 4.5, -11, 1.8, 1.8, 1.8, { ink: BL });
  box(5, 4.5, -11, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Mooring Bollard
  cyl(13, 0, -27, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(13, 0 + 1.0, -27, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Cargo Crate
  box(45, 0, -43, 1.8, 1.8, 1.8, { ink: BL });
  box(45, 0, -43, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(9, 0, -27, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(13, 0, -31, 1.8, 1.8, 1.8, { ink: BL });
  box(13, 0, -31, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(-23, 0, 21, 1.8, 1.8, 1.8, { ink: BL });
  box(-23, 0, 21, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(-11, 4.5, 9, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(-15, 0, 29, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(-35, 0, 37, 1.8, 1.8, 1.8, { ink: BL });
  box(-35, 0, 37, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(-23, 0, 45, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(-27, 0, 17, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(-35, 0, 17, 1.8, 1.8, 1.8, { ink: BL });
  box(-35, 0, 17, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(-43, 0, 45, 1.8, 1.8, 1.8, { ink: BL });
  box(-43, 0, 45, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(-23, 0, 5, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(-7, 0, 25, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(-3, 0, 49, 1.8, 1.8, 1.8, { ink: BL });
  box(-3, 0, 49, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Cargo Crate
  box(-35, 0, 29, 1.8, 1.8, 1.8, { ink: BL });
  box(-35, 0, 29, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(1, 0, 25, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(21, 0, 1, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(21, 0 + 1.0, 1, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Timber Stack
  box(13, 0, 25, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(13, 0, 45, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(9, 0, 45, 1.8, 1.8, 1.8, { ink: BL });
  box(9, 0, 45, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(9, 0, 21, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(5, 0, 37, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(5, 0 + 1.0, 37, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(13, 0, 49, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(9, 0, 29, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(9, 0, 33, 1.8, 1.8, 1.8, { ink: BL });
  box(9, 0, 33, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(21, 0, 9, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(17, 0, 33, 1.8, 1.8, 1.8, { ink: BL });
  box(17, 0, 33, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Cargo Crate
  box(13, 0, 29, 1.8, 1.8, 1.8, { ink: BL });
  box(13, 0, 29, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(1, 0, 37, 1.8, 1.8, 1.8, { ink: BL });
  box(1, 0, 37, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
