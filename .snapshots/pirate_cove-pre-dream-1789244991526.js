...
export function buildPirateCove(B, arena = false) {
  ...
  // === MACRO STRUCTURE: Galleon Sterncastle at (-31, 0, -1) ===
  box(-31, 0, -1, 8.0, 2.0, 6.0, { ink: BL });
  box(-31, 0 + 2.0, -1, 7.5, 2.5, 5.5, { ink: OR });
  slab(-31 - 4.0, -1 - 3.2, -31 + 4.0, -1 + 3.2, 0 + 4.5, 0.3, { ink: OR });
  rail(-31 - 4.0, -1 - 3.2, -31 + 4.0, -1 - 3.2, 0 + 4.5, { ink: BK });
  rail(-31 - 4.0, -1 + 3.2, -31 + 4.0, -1 + 3.2, 0 + 4.5, { ink: BK });
  rail(-31 - 4.0, -1 - 3.2, -31 - 4.0, -1 + 3.2, 0 + 4.5, { ink: BK });
  box(-31, 0 + 4.8, -1, 1.0, 3.0, 0.5, { ink: BK });
  ring(-31, 0 + 9.3, -1, 'z');
  pickup(-31, 0 + 4.7, -1);
  ...
  // === MACRO STRUCTURE: Cargo Crane Gantry at (-19, 0, 11) ===
  box(-19 - 2.5, 0, 11 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-19 + 2.5, 0, 11 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-19 - 2.5, 0, 11 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-19 + 2.5, 0, 11 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  slab(-19 - 3.0, 11 - 3.0, -19 + 3.0, 11 + 3.0, 0 + 5.5, 0.4, { ink: OR });
  box(-19, 0 + 5.9, 11 - 1.5, 2.5, 1.8, 2.5, { ink: BL });
  box(-19, 0 + 5.9, 11 + 2.5, 0.6, 0.6, 3.0, { ink: BK });
  ring(-19, 0 + 8.3, 11 + 4.0, 'z');
  pickup(-19, 0 + 6.1, 11 - 1.5);
  ...
  // Prop: Mooring Bollard
  cyl(-19, 0, -3, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-19, 0 + 1.0, -3, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Cargo Crate
  box(-15, 0, -47, 1.8, 1.8, 1.8, { ink: BL });
  box(-15, 0, -47, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(-19, 0, -43, 1.8, 1.8, 1.8, { ink: BL });
  box(-19, 0, -43, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(-3, 4.5, -7, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(-3, 0, -23, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-3, 0 + 1.0, -23, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Mooring Bollard
  cyl(-3, 0, -31, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-3, 0 + 1.0, -31, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(-23, 0, -11, 1.8, 1.8, 1.8, { ink: BL });
  box(-23, 0, -11, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(-19, 0, -15, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(-15, 0, -43, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(-47, 0, -31, 1.8, 1.8, 1.8, { ink: BL });
  box(-47, 0, -31, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(-19, 0, -31, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(25, 0, -3, 1.8, 1.8, 1.8, { ink: BL });
  box(25, 0, -3, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Cargo Crate
  box(25, 0, -43, 1.8, 1.8, 1.8, { ink: BL });
  box(25, 0, -43, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(21, 0, -47, 1.8, 1.8, 1.8, { ink: BL });
  box(21, 0, -47, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Mooring Bollard
  cyl(5, 0, -19, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(5, 0 + 1.0, -19, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Cargo Crate
  box(37, 0, -47, 1.8, 1.8, 1.8, { ink: BL });
  box(37, 0, -47, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Cargo Crate
  box(29, 0, -11, 1.8, 1.8, 1.8, { ink: BL });
  box(29, 0, -11, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(33, 0, -3, 1.8, 1.8, 1.8, { ink: BL });
  box(33, 0, -3, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(37, 0, -7, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(45, 0, -47, 1.8, 1.8, 1.8, { ink: BL });
  box(45, 0, -47, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(-43, 0, 21, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(-35, 0, 41, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(-43, 0, 17, 1.8, 1.8, 1.8, { ink: BL });
  box(-43, 0, 17, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Cargo Crate
  box(-43, 0, 29, 1.8, 1.8, 1.8, { ink: BL });
  box(-43, 0, 29, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Mooring Bollard
  cyl(-31, 0, 49, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-31, 0 + 1.0, 49, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(-39, 0, 41, 1.8, 1.8, 1.8, { ink: BL });
  box(-39, 0, 41, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(-47, 0, 49, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Mooring Bollard
  cyl(-35, 0, 45, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-35, 0 + 1.0, 45, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(-47, 0, 13, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Mooring Bollard
  cyl(29, 0, 29, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(29, 0 + 1.0, 29, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(29, 0, 13, 1.8, 1.8, 1.8, { ink: BL });
  box(29, 0, 13, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Mooring Bollard
  cyl(5, 0, 41, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(5, 0 + 1.0, 41, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Timber Stack
  box(41, 0, 25, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(17, 0, 21, 1.8, 1.8, 1.8, { ink: BL });
  box(17, 0, 21, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
