...
export function buildPirateCove(B, arena = false) {
  ...
  // Prop: Timber Stack
  box(-47, 0, -47, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(-19, 0, -11, 1.8, 1.8, 1.8, { ink: BL });
  box(-19, 0, -11, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Cargo Crate
  box(-7, 0, -47, 1.8, 1.8, 1.8, { ink: BL });
  box(-7, 0, -47, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(-19, 0, -39, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(9, 0, -43, 1.8, 1.8, 1.8, { ink: BL });
  box(9, 0, -43, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(33, 0, -27, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(41, 0, -39, 1.8, 1.8, 1.8, { ink: BL });
  box(41, 0, -39, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(45, 0, -11, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(17, 0, -19, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(17, 0 + 1.0, -19, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Timber Stack
  box(33, 0, -23, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(37, 0, -35, 1.8, 1.8, 1.8, { ink: BL });
  box(37, 0, -35, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Mooring Bollard
  cyl(-15, 0, 21, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-15, 0 + 1.0, 21, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Mooring Bollard
  cyl(-19, 0, 9, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-19, 0 + 1.0, 9, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Mooring Bollard
  cyl(-15, 0, 13, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-15, 0 + 1.0, 13, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(-47, 0, 37, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(-47, 0, 5, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(-7, 0, 37, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(-7, 0, 49, 1.8, 1.8, 1.8, { ink: BL });
  box(-7, 0, 49, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Mooring Bollard
  cyl(-19, 0, 17, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-19, 0 + 1.0, 17, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Cargo Crate
  box(-11, 0, 25, 1.8, 1.8, 1.8, { ink: BL });
  box(-11, 0, 25, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(-31, 0, 45, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Mooring Bollard
  cyl(25, 0, 9, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(25, 0 + 1.0, 9, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Mooring Bollard
  cyl(21, 0, 25, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(21, 0 + 1.0, 25, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(5, 0, 37, 1.8, 1.8, 1.8, { ink: BL });
  box(5, 0, 37, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Cargo Crate
  box(25, 0, 13, 1.8, 1.8, 1.8, { ink: BL });
  box(25, 0, 13, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(33, 0, 1, 1.8, 1.8, 1.8, { ink: BL });
  box(33, 0, 1, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(29, 0, 41, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(21, 0, 37, 1.8, 1.8, 1.8, { ink: BL });
  box(21, 0, 37, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
