...
export function buildPirateCove(B, arena = false) {
  ...
  // === MACRO STRUCTURE: Galleon Sterncastle at (-43, 0, -37) ===
  box(-43, 0, -37, 8.0, 2.0, 6.0, { ink: BL });
  box(-43, 0 + 2.0, -37, 7.5, 2.5, 5.5, { ink: OR });
  slab(-43 - 4.0, -37 - 3.2, -43 + 4.0, -37 + 3.2, 0 + 4.5, 0.3, { ink: OR });
  rail(-43 - 4.0, -37 - 3.2, -43 + 4.0, -37 - 3.2, 0 + 4.5, { ink: BK });
  rail(-43 - 4.0, -37 + 3.2, -43 + 4.0, -37 + 3.2, 0 + 4.5, { ink: BK });
  rail(-43 - 4.0, -37 - 3.2, -43 - 4.0, -37 + 3.2, 0 + 4.5, { ink: BK });
  box(-43, 0 + 4.8, -37, 1.0, 3.0, 0.5, { ink: BK });
  ring(-43, 0 + 9.3, -37, 'z');
  pickup(-43, 0 + 4.7, -37);
  ...
  // === MACRO STRUCTURE: Cargo Crane Gantry at (-31, 0, 11) ===
  box(-31 - 2.5, 0, 11 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-31 + 2.5, 0, 11 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-31 - 2.5, 0, 11 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-31 + 2.5, 0, 11 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  slab(-31 - 3.0, 11 - 3.0, -31 + 3.0, 11 + 3.0, 0 + 5.5, 0.4, { ink: OR });
  box(-31, 0 + 5.9, 11 - 1.5, 2.5, 1.8, 2.5, { ink: BL });
  box(-31, 0 + 5.9, 11 + 2.5, 0.6, 0.6, 3.0, { ink: BK });
  ring(-31, 0 + 8.3, 11 + 4.0, 'z');
  pickup(-31, 0 + 6.1, 11 - 1.5);
  ...
  cyl(-23, 0, -11, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-23, 0 + 1.0, -11, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(-39, 4.5, -39, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Timber Stack
  box(-43, 4.5, -35, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(-3, 0, -31, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(-27, 0, -27, 1.8, 1.8, 1.8, { ink: BL });
  box(-27, 0, -27, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(-43, 0, -15, 1.8, 1.8, 1.8, { ink: BL });
  box(-43, 0, -15, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(-27, 0, -15, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Mooring Bollard
  cyl(-15, 0, -35, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-15, 0 + 1.0, -35, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(5, 0, -47, 1.8, 1.8, 1.8, { ink: BL });
  box(5, 0, -47, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(5, 0, -39, 1.8, 1.8, 1.8, { ink: BL });
  box(5, 0, -39, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(21, 0, -31, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(17, 0, -39, 1.8, 1.8, 1.8, { ink: BL });
  box(17, 0, -39, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Mooring Bollard
  cyl(45, 0, -47, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(45, 0 + 1.0, -47, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Timber Stack
  box(-11, 4.5, 1, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Timber Stack
  box(-7, 0, 21, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(-23, 0, 41, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(-3, 4.5, 1, 1.8, 1.8, 1.8, { ink: BL });
  box(-3, 4.5, 1, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Mooring Bollard
  cyl(-15, 0, 25, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-15, 0 + 1.0, 25, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(-7, 0, 45, 1.8, 1.8, 1.8, { ink: BL });
  box(-7, 0, 45, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Mooring Bollard
  cyl(37, 0, 21, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(37, 0 + 1.0, 21, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(5, 4.5, 1, 1.8, 1.8, 1.8, { ink: BL });
  box(5, 4.5, 1, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(37, 0, 33, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(45, 0, 21, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(49, 0, 1, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(33, 0, 41, 1.8, 1.8, 1.8, { ink: BL });
  box(33, 0, 41, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Mooring Bollard
  cyl(49, 0, 37, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(49, 0 + 1.0, 37, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(37, 0, 1, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(45, 0, 17, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(45, 0 + 1.0, 17, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Mooring Bollard
  cyl(41, 0, 33, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(41, 0 + 1.0, 33, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Timber Stack
  box(37, 0, 29, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(33, 0, 37, 1.8, 1.8, 1.8, { ink: BL });
  box(33, 0, 37, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(45, 0, 5, 1.8, 1.8, 1.8, { ink: BL });
  box(45, 0, 5, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(33, 0, 33, 1.8, 1.8, 1.8, { ink: BL });
  box(33, 0, 33, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(37, 0, 17, 3.0, 1.0, 1.2, { ink: OR });
