...
export function buildPirateCove(B, arena = false) {
  ...
  // === MACRO STRUCTURE: Galleon Sterncastle at (-43, 0, -1) ===
  box(-43, 0, -1, 8.0, 2.0, 6.0, { ink: BL });
  box(-43, 0 + 2.0, -1, 7.5, 2.5, 5.5, { ink: OR });
  slab(-43 - 4.0, -1 - 3.2, -43 + 4.0, -1 + 3.2, 0 + 4.5, 0.3, { ink: OR });
  rail(-43 - 4.0, -1 - 3.2, -43 + 4.0, -1 - 3.2, 0 + 4.5, { ink: BK });
  rail(-43 - 4.0, -1 + 3.2, -43 + 4.0, -1 + 3.2, 0 + 4.5, { ink: BK });
  rail(-43 - 4.0, -1 - 3.2, -43 - 4.0, -1 + 3.2, 0 + 4.5, { ink: BK });
  box(-43, 0 + 4.8, -1, 1.0, 3.0, 0.5, { ink: BK });
  ring(-43, 0 + 9.3, -1, 'z');
  pickup(-43, 0 + 4.7, -1);

  // === MACRO STRUCTURE: Cargo Crane Gantry at (-43, 0, 35) ===
  box(-43 - 2.5, 0, 35 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-43 + 2.5, 0, 35 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-43 - 2.5, 0, 35 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-43 + 2.5, 0, 35 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  slab(-43 - 3.0, 35 - 3.0, -43 + 3.0, 35 + 3.0, 0 + 5.5, 0.4, { ink: OR });
  box(-43, 0 + 5.9, 35 - 1.5, 2.5, 1.8, 2.5, { ink: BL });
  box(-43, 0 + 5.9, 35 + 2.5, 0.6, 0.6, 3.0, { ink: BK });
  ring(-43, 0 + 8.3, 35 + 4.0, 'z');
  pickup(-43, 0 + 6.1, 35 - 1.5);
  ...
  // Prop: Cargo Crate
  box(-31, 0, -31, 1.8, 1.8, 1.8, { ink: BL });
  box(-31, 0, -31, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Mooring Bollard
  cyl(-43, 0, -19, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-43, 0 + 1.0, -19, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Mooring Bollard
  cyl(-35, 0, -19, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-35, 0 + 1.0, -19, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Cargo Crate
  box(-27, 0, -47, 1.8, 1.8, 1.8, { ink: BL });
  box(-27, 0, -47, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(-35, 0, -31, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Timber Stack
  box(-27, 0, -27, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(-19, 0, -27, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-19, 0 + 1.0, -27, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Mooring Bollard
  cyl(21, 0, -39, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(21, 0 + 1.0, -39, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Mooring Bollard
  cyl(17, 0, -11, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(17, 0 + 1.0, -11, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(21, 0, -7, 1.8, 1.8, 1.8, { ink: BL });
  box(21, 0, -7, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(29, 0, -39, 1.8, 1.8, 1.8, { ink: BL });
  box(29, 0, -39, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(33, 0, -31, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(13, 0, -43, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(13, 0 + 1.0, -43, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(17, 0, -15, 1.8, 1.8, 1.8, { ink: BL });
  box(17, 0, -15, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(49, 0, -35, 1.8, 1.8, 1.8, { ink: BL });
  box(49, 0, -35, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Mooring Bollard
  cyl(-11, 0, 17, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-11, 0 + 1.0, 17, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Mooring Bollard
  cyl(-7, 0, 33, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-7, 0 + 1.0, 33, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(-47, 0, 9, 1.8, 1.8, 1.8, { ink: BL });
  box(-47, 0, 9, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Cargo Crate
  box(-11, 0, 49, 1.8, 1.8, 1.8, { ink: BL });
  box(-11, 0, 49, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(-35, 0, 45, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(-27, 0, 29, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Timber Stack
  box(-39, 0, 41, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Mooring Bollard
  cyl(-39, 4.5, 1, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-39, 4.5 + 1.0, 1, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Cargo Crate
  box(-11, 0, 45, 1.8, 1.8, 1.8, { ink: BL });
  box(-11, 0, 45, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Mooring Bollard
  cyl(-3, 0, 49, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-3, 0 + 1.0, 49, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(-3, 0, 37, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(-35, 0, 41, 1.8, 1.8, 1.8, { ink: BL });
  box(-35, 0, 41, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(-7, 0, 49, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(-23, 0, 13, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-23, 0 + 1.0, 13, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Timber Stack
  box(21, 0, 45, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(21, 0, 13, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(29, 0, 33, 1.8, 1.8, 1.8, { ink: BL });
  box(29, 0, 33, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(1, 0, 29, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(33, 0, 29, 1.8, 1.8, 1.8, { ink: BL });
  box(33, 0, 29, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Mooring Bollard
  cyl(37, 0, 41, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(37, 0 + 1.0, 41, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(37, 0, 25, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(17, 0, 37, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(17, 0 + 1.0, 37, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Mooring Bollard
  cyl(33, 0, 5, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(33, 0 + 1.0, 5, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Cargo Crate
  box(29, 0, 45, 1.8, 1.8, 1.8, { ink: BL });
  box(29, 0, 45, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
