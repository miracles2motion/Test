...
export function buildPirateCove(B, arena = false) {
  ...
  // === MACRO STRUCTURE: Cargo Crane Gantry at (-43, 0, -37) ===
  box(-43 - 2.5, 0, -37 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-43 + 2.5, 0, -37 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-43 - 2.5, 0, -37 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-43 + 2.5, 0, -37 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  slab(-43 - 3.0, -37 - 3.0, -43 + 3.0, -37 + 3.0, 0 + 5.5, 0.4, { ink: OR });
  box(-43, 0 + 5.9, -37 - 1.5, 2.5, 1.8, 2.5, { ink: BL });
  box(-43, 0 + 5.9, -37 + 2.5, 0.6, 0.6, 3.0, { ink: BK });
  ring(-43, 0 + 8.3, -37 + 4.0, 'z');
  pickup(-43, 0 + 6.1, -37 - 1.5);
  ...
  cyl(-3, 4.5, -7, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-3, 4.5 + 1.0, -7, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(-47, 0, -27, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Mooring Bollard
  cyl(-39, 0, -3, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-39, 0 + 1.0, -3, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(-43, 0, -23, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Mooring Bollard
  cyl(-47, 0, -3, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-47, 0 + 1.0, -3, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Mooring Bollard
  cyl(-39, 0, -15, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-39, 0 + 1.0, -15, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Timber Stack
  box(-31, 0, -15, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(-31, 0, -7, 1.8, 1.8, 1.8, { ink: BL });
  box(-31, 0, -7, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(-23, 0, -19, 1.8, 1.8, 1.8, { ink: BL });
  box(-23, 0, -19, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(-35, 0, -23, 1.8, 1.8, 1.8, { ink: BL });
  box(-35, 0, -23, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(-35, 0, -47, 1.8, 1.8, 1.8, { ink: BL });
  box(-35, 0, -47, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Cargo Crate
  box(-27, 0, -43, 1.8, 1.8, 1.8, { ink: BL });
  box(-27, 0, -43, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(-47, 0, -11, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Mooring Bollard
  cyl(37, 0, -11, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(37, 0 + 1.0, -11, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Mooring Bollard
  cyl(21, 0, -27, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(21, 0 + 1.0, -27, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(33, 0, -3, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(37, 0, -43, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(41, 0, -19, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Mooring Bollard
  cyl(41, 0, -23, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(41, 0 + 1.0, -23, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(41, 0, -43, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(-11, 4.5, 1, 1.8, 1.8, 1.8, { ink: BL });
  box(-11, 4.5, 1, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(-27, 0, 5, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Timber Stack
  box(-43, 0, 41, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(-31, 0, 9, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-31, 0 + 1.0, 9, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Timber Stack
  box(-35, 0, 9, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(-35, 0, 13, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-35, 0 + 1.0, 13, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(-27, 0, 21, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(-47, 0, 45, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Timber Stack
  box(-39, 0, 25, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(-31, 0, 21, 1.8, 1.8, 1.8, { ink: BL });
  box(-31, 0, 21, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Mooring Bollard
  cyl(-47, 0, 5, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-47, 0 + 1.0, 5, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(-39, 4.5, 17, 1.8, 1.8, 1.8, { ink: BL });
  box(-39, 4.5, 17, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(-23, 0, 49, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(17, 0, 49, 1.8, 1.8, 1.8, { ink: BL });
  box(17, 0, 49, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Timber Stack
  box(29, 0, 9, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(29, 0, 41, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(29, 0 + 1.0, 41, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Timber Stack
  box(13, 0, 37, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Cargo Crate
  box(1, 4.5, 1, 1.8, 1.8, 1.8, { ink: BL });
  box(1, 4.5, 1, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Mooring Bollard
  cyl(29, 0, 37, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(29, 0 + 1.0, 37, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(25, 0, 21, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(41, 0, 49, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(41, 0 + 1.0, 49, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(37, 0, 37, 1.8, 1.8, 1.8, { ink: BL });
  box(37, 0, 37, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Cargo Crate
  box(1, 4.5, 9, 1.8, 1.8, 1.8, { ink: BL });
  box(1, 4.5, 9, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(17, 0, 17, 3.0, 1.0, 1.2, { ink: OR });
