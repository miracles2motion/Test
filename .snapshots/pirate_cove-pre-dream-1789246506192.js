...
export function buildPirateCove(B, arena = false) {
  ...
  // Prop: Bone Spike
  cyl(-11, 0, -27, 0.6, 1.5, { seg: 6, ink: WH });
  cyl(-11, 0 + 1.5, -27, 0.4, 1.5, { seg: 6, ink: WH });
  cyl(-11, 0 + 3.0, -27, 0.2, 1.0, { seg: 6, ink: WH });

  // Prop: Bone Spike
  cyl(-3, 0, -35, 0.6, 1.5, { seg: 6, ink: WH });
  cyl(-3, 0 + 1.5, -35, 0.4, 1.5, { seg: 6, ink: WH });
  cyl(-3, 0 + 3.0, -35, 0.2, 1.0, { seg: 6, ink: WH });
  ...
  // Prop: Bone Spike
  cyl(-3, 0, -31, 0.6, 1.5, { seg: 6, ink: WH });
  cyl(-3, 0 + 1.5, -31, 0.4, 1.5, { seg: 6, ink: WH });
  cyl(-3, 0 + 3.0, -31, 0.2, 1.0, { seg: 6, ink: WH });
  ...
  cyl(1, 0 + 4.0, -35 + 5.5, 0.2, 4.0, { seg: 4, ink: WH }); // Cable
  ...
  cyl(13, 0 + 4.0, -31 + 5.5, 0.2, 4.0, { seg: 4, ink: WH }); // Cable

  // Prop: Shipyard Crane
  box(41, 0, -47, 1.5, 9.0, 1.5, { ink: BK }); // Iron pillar
  box(41, 0 + 8.0, -47 + 3.0, 1.0, 1.0, 6.0, { ink: BK }); // Crane arm
  cyl(41, 0 + 4.0, -47 + 5.5, 0.2, 4.0, { seg: 4, ink: WH }); // Cable
  ...
  box(-39, 0 + 2.2, 9, 2.0, 0.8, 4.2, { ink: WH }); // Raised center
  ...
  box(-15, 0 + 2.2, 29, 2.0, 0.8, 4.2, { ink: WH }); // Raised center
