...
export function buildPirateCove(B, arena = false) {
  ...
  // === MACRO STRUCTURE: Torii Gate Overlook at (-25, 0, -37) ===
  box(-25 - 3.0, 0, -37, 0.8, 6.0, 0.8, { ink: RD });
  box(-25 + 3.0, 0, -37, 0.8, 6.0, 0.8, { ink: RD });
  box(-25, 0 + 5.2, -37, 7.4, 0.6, 1.0, { ink: RD });
  box(-25, 0 + 4.4, -37, 6.2, 0.4, 0.6, { ink: RD });
  slab(-25 - 3.5, -37 - 1.5, -25 + 3.5, -37 + 1.5, 0 + 4.0, 0.3, { ink: OR });
  rail(-25 - 3.5, -37 - 1.5, -25 + 3.5, -37 - 1.5, 0 + 4.0, { ink: BK });
  rail(-25 - 3.5, -37 + 1.5, -25 + 3.5, -37 + 1.5, 0 + 4.0, { ink: BK });
  box(-25 - 2.5, 0, -37 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  box(-25 + 2.5, 0, -37 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  ring(-25, 0 + 8.3, -37, 'z');

  // === MACRO STRUCTURE: Torii Gate Overlook at (-25, 0, -13) ===
  box(-25 - 3.0, 0, -13, 0.8, 6.0, 0.8, { ink: RD });
  box(-25 + 3.0, 0, -13, 0.8, 6.0, 0.8, { ink: RD });
  box(-25, 0 + 5.2, -13, 7.4, 0.6, 1.0, { ink: RD });
  box(-25, 0 + 4.4, -13, 6.2, 0.4, 0.6, { ink: RD });
  slab(-25 - 3.5, -13 - 1.5, -25 + 3.5, -13 + 1.5, 0 + 4.0, 0.3, { ink: OR });
  rail(-25 - 3.5, -13 - 1.5, -25 + 3.5, -13 - 1.5, 0 + 4.0, { ink: BK });
  rail(-25 - 3.5, -13 + 1.5, -25 + 3.5, -13 + 1.5, 0 + 4.0, { ink: BK });
  box(-25 - 2.5, 0, -13 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  box(-25 + 2.5, 0, -13 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  ring(-25, 0 + 8.3, -13, 'z');

  // === MACRO STRUCTURE: Torii Gate Overlook at (-25, 0, 5) ===
  box(-25 - 3.0, 0, 5, 0.8, 6.0, 0.8, { ink: RD });
  box(-25 + 3.0, 0, 5, 0.8, 6.0, 0.8, { ink: RD });
  box(-25, 0 + 5.2, 5, 7.4, 0.6, 1.0, { ink: RD });
  box(-25, 0 + 4.4, 5, 6.2, 0.4, 0.6, { ink: RD });
  slab(-25 - 3.5, 5 - 1.5, -25 + 3.5, 5 + 1.5, 0 + 4.0, 0.3, { ink: OR });
  rail(-25 - 3.5, 5 - 1.5, -25 + 3.5, 5 - 1.5, 0 + 4.0, { ink: BK });
  rail(-25 - 3.5, 5 + 1.5, -25 + 3.5, 5 + 1.5, 0 + 4.0, { ink: BK });
  box(-25 - 2.5, 0, 5 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  box(-25 + 2.5, 0, 5 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  ring(-25, 0 + 8.3, 5, 'z');

  // === MACRO STRUCTURE: Torii Gate Overlook at (-26.102147146022062, 0, 21.72998335334736) ===
  box(-26.102147146022062 - 3.0, 0, 21.72998335334736, 0.8, 6.0, 0.8, { ink: RD });
  box(-26.102147146022062 + 3.0, 0, 21.72998335334736, 0.8, 6.0, 0.8, { ink: RD });
  box(-26.102147146022062, 0 + 5.2, 21.72998335334736, 7.4, 0.6, 1.0, { ink: RD });
  box(-26.102147146022062, 0 + 4.4, 21.72998335334736, 6.2, 0.4, 0.6, { ink: RD });
  slab(-26.102147146022062 - 3.5, 21.72998335334736 - 1.5, -26.102147146022062 + 3.5, 21.72998335334736 + 1.5, 0 + 4.0, 0.3, { ink: OR });
  rail(-26.102147146022062 - 3.5, 21.72998335334736 - 1.5, -26.102147146022062 + 3.5, 21.72998335334736 - 1.5, 0 + 4.0, { ink: BK });
  rail(-26.102147146022062 - 3.5, 21.72998335334736 + 1.5, -26.102147146022062 + 3.5, 21.72998335334736 + 1.5, 0 + 4.0, { ink: BK });
  box(-26.102147146022062 - 2.5, 0, 21.72998335334736 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  box(-26.102147146022062 + 2.5, 0, 21.72998335334736 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  ring(-26.102147146022062, 0 + 8.3, 21.72998335334736, 'z');
