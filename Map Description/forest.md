...
- **Environment Dossier**: Forest — CYBER THEMATIC SECTOR
...
- **Tier 2 (Tactical Furniture & Walkways — 5-10 meshes each)**: synthetic diner booth table, server rack array (2.0m x 2.2m x 1.0m), reinforced cable bundle riser, holographic ad totem.
  - Elevated platforms at Y = 1.2m–3.0m with structural posts and balustrades.
- **Tier 3 (Landmark Anchor Props — 10-20 meshes each)**: monolithic mainframe core, skybridge transit catwalk, rooftop communication dish array, reinforced blast gate.
  - Central sector landmarks providing multi-story traversal and grapple anchors.
- **Tier 4 (Kinetic & Aerial Elements)**: pulsing fiber conduit glow, paper drones on automated flightpaths, rotating exhaust turbine.
...
- **Tier 1 Props**: holo-terminal console, conduit junction box.
- **Tier 2 Props**: synthetic diner booth table.
...
- **Tier 1 Props**: neon billboard frame, cooling vent register.
- **Tier 2 Props**: server rack array (2.0m x 2.2m x 1.0m).
...
- **Tier 1 Props**: holo-terminal console, cooling vent register.
...
- **Tier 2 Props**: reinforced cable bundle riser.
...
- **Tier 3 Landmark**: monolithic mainframe core & skybridge transit catwalk.
...
- **Kinetic Elements**: pulsing fiber conduit glow, paper drones on automated flightpaths, rotating exhaust turbine.
...
- **Neon Data Vault (X=-43, Z=23)**: Fortified server room with tiered walkways, glowing conduits, and rooftop grapple.
- **Holographic Kiosk Tower (X=-43, Z=41)**: Narrow vertical tower with wrap-around ledge, holographic display, and sniper perch.
- **Neon Data Vault (X=-31, Z=-13)**: Fortified server room with tiered walkways, glowing conduits, and rooftop grapple.
- **Skybridge Transit Junction (X=-31, Z=11)**: Elevated transit platform with twin pylons, suspended walkway, and cover nodes.
