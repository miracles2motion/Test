...
- **Environment Dossier**: Cover — STEAMPUNK THEMATIC SECTOR
- **Tactical Category**: `steampunk`
...
- **Tier 1 (Cover Props — 3-5 meshes each)**: brass pressure gauge, steam exhaust nozzle, escapement pallet fork, interlocking cog pinion.
  - Height range: 0.8m–1.3m providing low crouch cover.
  - Material: Primary + Secondary ink with accent trim.
- **Tier 2 (Tactical Furniture & Walkways — 5-10 meshes each)**: crankshaft piston housing, furnace hopper bin (2.0m x 1.4m x 1.6m), riveted pressure boiler tank, heavy chain winch spindle.
  - Elevated platforms at Y = 1.2m–3.0m with structural posts and balustrades.
- **Tier 3 (Landmark Anchor Props — 10-20 meshes each)**: colossal 14-tooth mainspring gear, clock tower chime pendulum shaft, smelting furnace chimney, high-pressure steam manifold bridge.
  - Central sector landmarks providing multi-story traversal and grapple anchors.
- **Tier 4 (Kinetic & Aerial Elements)**: counter-rotating spur gears, plunging steam hammer piston, drifting paper gliders.
...
- **Tier 1 Props**: brass pressure gauge, steam exhaust nozzle.
- **Tier 2 Props**: crankshaft piston housing.
...
- **Tier 1 Props**: escapement pallet fork, interlocking cog pinion.
- **Tier 2 Props**: furnace hopper bin (2.0m x 1.4m x 1.6m).
...
- **Tier 1 Props**: brass pressure gauge, interlocking cog pinion.
...
- **Tier 2 Props**: riveted pressure boiler tank.
...
- **Tier 3 Landmark**: colossal 14-tooth mainspring gear & clock tower chime pendulum shaft.
...
- **Kinetic Elements**: counter-rotating spur gears, plunging steam hammer piston, drifting paper gliders.
