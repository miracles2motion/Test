...
- **Environment Dossier**: Pirate Cove — MARITIME THEMATIC SECTOR
- **Tactical Category**: `maritime`
...
- **Tier 1 (Cover Props — 3-5 meshes each)**: mooring bollard post, coiled rope spool ring, brass ship lantern, anchor chain link.
  - Height range: 0.8m–1.3m providing low crouch cover.
  - Material: Primary + Secondary ink with accent trim.
- **Tier 2 (Tactical Furniture & Walkways — 5-10 meshes each)**: cargo crate pyramid (1.8m x 1.8m x 1.8m), shipwright timber workbench, crow's nest basket barrier, drydock keel block.
  - Elevated platforms at Y = 1.2m–3.0m with structural posts and balustrades.
- **Tier 3 (Landmark Anchor Props — 10-20 meshes each)**: galleon sterncastle deck, rigging mast apex spar, harbor crane jib boom, lighthouse beacon cupola.
  - Central sector landmarks providing multi-story traversal and grapple anchors.
- **Tier 4 (Kinetic & Aerial Elements)**: buoyant dock bobbing on swell, paper seagulls banking on wind shear, swinging cargo hoist hook.
...
- **Tier 1 Props**: mooring bollard post, coiled rope spool ring.
- **Tier 2 Props**: cargo crate pyramid (1.8m x 1.8m x 1.8m).
...
- **Tier 1 Props**: brass ship lantern, anchor chain link.
- **Tier 2 Props**: shipwright timber workbench.
...
- **Tier 1 Props**: mooring bollard post, anchor chain link.
...
- **Tier 2 Props**: crow's nest basket barrier.
...
- **Kinetic Elements**: buoyant dock bobbing on swell, paper seagulls banking on wind shear, swinging cargo hoist hook.
