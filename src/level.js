...
import { buildSeas } from './levels/seas.js';
  ...
  { key: 'seas',
    customEnemies: {
      ...
      rigging_marksman: {
        ...
        name: "RIGGING MARKSMAN",
        score: 150,
        scale: 1
      }
    }, name: 'THE INK SEAS', blurb: 'twin galleons, rigging, and kraken tentacles', category: 'colossal', tags: ['VERTICAL', 'TITANIC', 'MARITIME'], env: 'Maritime Combat', engagement: 'Ship-to-Ship / Grapple', hazard: 'Drowning', scale: 'Tier 1-5' },
