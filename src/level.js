...
export const LEVELS = [
  ...
  { key: 'forest', name: 'THE COLOSSAL CANOPY', blurb: 'primeval redwoods, banyan roots, hollow log tunnels & high suspension bridges', category: 'colossal', tags: ['VERTICAL', 'MASSIVE', 'CANOPY'], env: 'Primeval Redwood Forest', engagement: '3-Lane / Sniping / Grapple', hazard: 'Abyssal Chasm below Y=-10.0m', scale: 'Tier 1-4' },
