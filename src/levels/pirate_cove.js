...
export function buildPirateCove(B, arena = false) {
  ...
  // === MACRO STRUCTURE: Torii Gate Overlook at (-25, 0, -25) ===
  box(-25 - 3.0, 0, -25, 0.8, 6.0, 0.8, { ink: RD });
  box(-25 + 3.0, 0, -25, 0.8, 6.0, 0.8, { ink: RD });
  box(-25, 0 + 5.2, -25, 7.4, 0.6, 1.0, { ink: RD });
  box(-25, 0 + 4.4, -25, 6.2, 0.4, 0.6, { ink: RD });
  slab(-25 - 3.5, -25 - 1.5, -25 + 3.5, -25 + 1.5, 0 + 4.0, 0.3, { ink: OR });
  rail(-25 - 3.5, -25 - 1.5, -25 + 3.5, -25 - 1.5, 0 + 4.0, { ink: BK });
  rail(-25 - 3.5, -25 + 1.5, -25 + 3.5, -25 + 1.5, 0 + 4.0, { ink: BK });
  box(-25 - 2.5, 0, -25 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  box(-25 + 2.5, 0, -25 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  ring(-25, 0 + 8.3, -25, 'z');

  // === MACRO STRUCTURE: Torii Gate Overlook at (-25, 0, -7) ===
  box(-25 - 3.0, 0, -7, 0.8, 6.0, 0.8, { ink: RD });
  box(-25 + 3.0, 0, -7, 0.8, 6.0, 0.8, { ink: RD });
  box(-25, 0 + 5.2, -7, 7.4, 0.6, 1.0, { ink: RD });
  box(-25, 0 + 4.4, -7, 6.2, 0.4, 0.6, { ink: RD });
  slab(-25 - 3.5, -7 - 1.5, -25 + 3.5, -7 + 1.5, 0 + 4.0, 0.3, { ink: OR });
  rail(-25 - 3.5, -7 - 1.5, -25 + 3.5, -7 - 1.5, 0 + 4.0, { ink: BK });
  rail(-25 - 3.5, -7 + 1.5, -25 + 3.5, -7 + 1.5, 0 + 4.0, { ink: BK });
  box(-25 - 2.5, 0, -7 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  box(-25 + 2.5, 0, -7 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  ring(-25, 0 + 8.3, -7, 'z');

  // === MACRO STRUCTURE: Torii Gate Overlook at (-13.711913760188004, 0, -38.02771831732997) ===
  box(-13.711913760188004 - 3.0, 0, -38.02771831732997, 0.8, 6.0, 0.8, { ink: RD });
  box(-13.711913760188004 + 3.0, 0, -38.02771831732997, 0.8, 6.0, 0.8, { ink: RD });
  box(-13.711913760188004, 0 + 5.2, -38.02771831732997, 7.4, 0.6, 1.0, { ink: RD });
  box(-13.711913760188004, 0 + 4.4, -38.02771831732997, 6.2, 0.4, 0.6, { ink: RD });
  slab(-13.711913760188004 - 3.5, -38.02771831732997 - 1.5, -13.711913760188004 + 3.5, -38.02771831732997 + 1.5, 0 + 4.0, 0.3, { ink: OR });
  rail(-13.711913760188004 - 3.5, -38.02771831732997 - 1.5, -13.711913760188004 + 3.5, -38.02771831732997 - 1.5, 0 + 4.0, { ink: BK });
  rail(-13.711913760188004 - 3.5, -38.02771831732997 + 1.5, -13.711913760188004 + 3.5, -38.02771831732997 + 1.5, 0 + 4.0, { ink: BK });
  box(-13.711913760188004 - 2.5, 0, -38.02771831732997 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  box(-13.711913760188004 + 2.5, 0, -38.02771831732997 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  ring(-13.711913760188004, 0 + 8.3, -38.02771831732997, 'z');

  // === MACRO STRUCTURE: Torii Gate Overlook at (-13, 0, 29) ===
  box(-13 - 3.0, 0, 29, 0.8, 6.0, 0.8, { ink: RD });
  box(-13 + 3.0, 0, 29, 0.8, 6.0, 0.8, { ink: RD });
  box(-13, 0 + 5.2, 29, 7.4, 0.6, 1.0, { ink: RD });
  box(-13, 0 + 4.4, 29, 6.2, 0.4, 0.6, { ink: RD });
  slab(-13 - 3.5, 29 - 1.5, -13 + 3.5, 29 + 1.5, 0 + 4.0, 0.3, { ink: OR });
  rail(-13 - 3.5, 29 - 1.5, -13 + 3.5, 29 - 1.5, 0 + 4.0, { ink: BK });
  rail(-13 - 3.5, 29 + 1.5, -13 + 3.5, 29 + 1.5, 0 + 4.0, { ink: BK });
  box(-13 - 2.5, 0, 29 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  box(-13 + 2.5, 0, 29 + 2.5, 0.6, 1.4, 0.6, { ink: BK });
  ring(-13, 0 + 8.3, 29, 'z');
