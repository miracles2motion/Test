...
export function buildPirateCove(B, arena = false) {
  ...
  stairs(0, 0, -12, stepCount, rs, rn, 3.2, 'N');
  stairs(0, 0, 12, stepCount, rs, rn, 3.2, 'S');
  ...
  cyl(-31, 0, -47, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-31, 0 + 1.0, -47, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Cargo Crate
  box(37, 0, -3, 1.8, 1.8, 1.8, { ink: BL });
  box(37, 0, -3, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
  ...
  // Prop: Timber Stack
  box(37, 0, -31, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(-39, 0, 17, 1.8, 1.8, 1.8, { ink: BL });
  box(-39, 0, 17, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });

  // Prop: Mooring Bollard
  cyl(-43, 0, 25, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-43, 0 + 1.0, 25, 0.5, 0.2, { seg: 8, ink: BK });

  // Prop: Timber Stack
  box(-43, 0, 33, 3.0, 1.0, 1.2, { ink: OR });

  // Prop: Mooring Bollard
  cyl(-43, 0, 49, 0.4, 1.0, { seg: 8, ink: BK });
  cyl(-43, 0 + 1.0, 49, 0.5, 0.2, { seg: 8, ink: BK });
  ...
  // Prop: Timber Stack
  box(-43, 0, 45, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Timber Stack
  box(25, 0, 33, 3.0, 1.0, 1.2, { ink: OR });
  ...
  // Prop: Cargo Crate
  box(1, 0, 21, 1.8, 1.8, 1.8, { ink: BL });
  box(1, 0, 21, 1.9, 1.9, 1.9, { noCollide: true, ink: BK });
