...
export function buildPirateCove(B, arena = false) {
  ...
  // === MACRO STRUCTURE: Cargo Crane Gantry at (-13, 0, -1) ===
  box(-13 - 2.5, 0, -1 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-13 + 2.5, 0, -1 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-13 - 2.5, 0, -1 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-13 + 2.5, 0, -1 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  slab(-13 - 3.0, -1 - 3.0, -13 + 3.0, -1 + 3.0, 0 + 5.5, 0.4, { ink: OR });
  box(-13, 0 + 5.9, -1 - 1.5, 2.5, 1.8, 2.5, { ink: BL });
  box(-13, 0 + 5.9, -1 + 2.5, 0.6, 0.6, 3.0, { ink: BK });
  ring(-13, 0 + 8.3, -1 + 4.0, 'z');
  pickup(-13, 0 + 6.1, -1 - 1.5);
