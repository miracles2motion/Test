...
export function buildPirateCove(B, arena = false) {
  ...
  // === MACRO STRUCTURE: Cargo Crane Gantry at (-1, 0, -13) ===
  box(-1 - 2.5, 0, -13 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-1 + 2.5, 0, -13 - 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-1 - 2.5, 0, -13 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  box(-1 + 2.5, 0, -13 + 2.5, 0.8, 6.0, 0.8, { ink: BK });
  slab(-1 - 3.0, -13 - 3.0, -1 + 3.0, -13 + 3.0, 0 + 5.5, 0.4, { ink: OR });
  box(-1, 0 + 5.9, -13 - 1.5, 2.5, 1.8, 2.5, { ink: BL });
  box(-1, 0 + 5.9, -13 + 2.5, 0.6, 0.6, 3.0, { ink: BK });
  ring(-1, 0 + 8.3, -13 + 4.0, 'z');
  pickup(-1, 0 + 6.1, -13 - 1.5);
